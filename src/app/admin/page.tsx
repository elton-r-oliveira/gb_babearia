            ...
            <div className="bg-neutral-800 rounded-lg p-4 border border-neutral-700 mb-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="flex items-end">
                  <button
                    ...
                    className="bg-yellow-600 text-black px-4 py-2 rounded-md hover:bg-yellow-500 transition w-full"
                  >
                    Aplicar Período
                  </button>
                </div>
              ...
              {dataInicio && dataFim && (
                <div className="mt-3 text-sm text-gray-300">
                  ...
                  <p className="text-xs text-gray-400">Incluindo todo o dia final selecionado (até 23:59:59)</p>
                </div>
              )}
            </div>
          )}
